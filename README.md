...
### 3.1 Installation
```shell
npm install js-epsilla
```
or
```shell
npm update js-epsilla
```

### 3.2 Use js-epsilla to connect to and interact with vector database

```javascript
const vectordb = require('js-epsilla').vectordb;
